...
import gradeMurmurTemplate from "../templates/gradeMurmurTemplate"

export default function gradeTheMurmurDudley({data}) {
   return gradeMurmurTemplate(data,dogName.DUDLEY)  
}
