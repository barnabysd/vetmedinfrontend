      ...
      <>
          ...
          style={{border: '0px solid black'}}>
            ...
            <Grid item xs={12} sm={5}  align="center" style={{border: '0px solid red'}}>
                ...
                {(currentCaseStudySlideData.mainImage && currentCaseStudySlideData.mainImage !== "" && dogChoice === dogName.DUDLEY)  ? 
                  <DogImageHolder><FixedSizeImage imgName={currentCaseStudySlideData.mainImage} height="600px" width="314px"/></DogImageHolder>
                : ''}
                  {(currentCaseStudySlideData.mainImage && currentCaseStudySlideData.mainImage !== "" && dogChoice === dogName.POPPY)  ? 
                  <DogImageHolder><FixedSizeImage imgName={currentCaseStudySlideData.mainImage} height="600px" width="314px"/></DogImageHolder>
                : ''}
                  {(currentCaseStudySlideData.mainImage && currentCaseStudySlideData.mainImage !== "" && dogChoice === dogName.REGGIE)  ? 
                  <DogImageHolder><FixedSizeImage imgName={currentCaseStudySlideData.mainImage} height="600px" width="314px"/></DogImageHolder>
                : ''}
